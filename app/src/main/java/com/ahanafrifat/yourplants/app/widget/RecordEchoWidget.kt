package com.ahanafrifat.yourplants.app.widget
...
import com.ahanafrifat.yourplants.app.MainActivity
import com.ahanafrifat.yourplants.app.navigation.ACTION_CREATE_ECHO
                    ...
                    modifier = GlanceModifier
                        .clickable {
                            ...
                            val intent = Intent(context, MainActivity::class.java).also {
                                it.data = "https//ahanafrifat.com/echos/true".toUri()
